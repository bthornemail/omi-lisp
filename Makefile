...
# Minimal build for the OMI-Lisp lowering + handoff + tiny parser stub.
# No evaluation, no validation, no receipt.
...
$(TEST_BIN_PARSE): $(OBJS) $(TEST_DIR)/test_parse.c $(SRC_DIR)/omi_parse.h $(SRC_DIR)/omi_candidate.h | $(BUILD_DIR)
