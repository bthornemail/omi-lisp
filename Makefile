...
TEST_BIN_AUTHORITY := $(BUILD_DIR)/test_authority_negative
...
all: $(TEST_BIN_SEED) $(TEST_BIN_PAIR) $(TEST_BIN_SYMBOL) $(TEST_BIN_CANDIDATE) $(TEST_BIN_PARSE) $(TEST_BIN_FIXTURES) $(TEST_BIN_NESTED) $(TEST_BIN_ADAPTER) $(TEST_BIN_BOUNDARY) $(TEST_BIN_AUTHORITY)
...
$(TEST_BIN_AUTHORITY): $(OBJS) $(TEST_DIR)/test_authority_negative.c $(SRC_DIR)/omi_canvas_boundary.h | $(BUILD_DIR)
	$(CC) $(CFLAGS) $(OBJS) $(TEST_DIR)/test_authority_negative.c -o $@

test: $(TEST_BIN_SEED) $(TEST_BIN_PAIR) $(TEST_BIN_SYMBOL) $(TEST_BIN_CANDIDATE) $(TEST_BIN_PARSE) $(TEST_BIN_FIXTURES) $(TEST_BIN_NESTED) $(TEST_BIN_ADAPTER) $(TEST_BIN_BOUNDARY) $(TEST_BIN_AUTHORITY)
	./$(TEST_BIN_SEED)
	./$(TEST_BIN_PAIR)
	./$(TEST_BIN_SYMBOL)
	./$(TEST_BIN_CANDIDATE)
